...
public class StockDemo
{
    ...
    public StockDemo(StockList stock)
    {
        ...
        stock.add(new Product(101, "Brabus Rocket 900"));
        stock.add(new Product(102, "ABT RS3"));
        stock.add(new Product(103, "Brabus E63S AMG"));
        stock.add(new Product(104, "BMW M8 Grand Coupe"));
        stock.add(new Product(105, "Lamborghini aventador SVJ"));
        stock.add(new Product(106, "Mercedes AMG GT Black Series"));
        stock.add(new Product(107, "ABT Audi R8 V10 Performace Quattro"));
        stock.add(new Product(108, "Lamborghini hurrican performante"));
        stock.add(new Product(109, "BMW M5 Competition"));
        stock.add(new Product(110, "ABT RS6"));
    }
